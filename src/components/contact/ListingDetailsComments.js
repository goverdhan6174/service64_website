                        ...
                        {this.states.comments.map((item, i) => {
                            return (
                                <>
                                        ...
                                        <div className="comment-body">
                                            <div className="meta-data">
                                                ...
                                                <div className="rating-rating">
                                                    {item.stars.map((star1, n) => {
                                                        return <span key={n} className="la la-star">{star1}</span>
                                                    })}
                                                </div>
                                            </div>
                                    ...
                                    {/* {item.replyComments ? (
                                        item.replyComments.map((item2, j) => {
                                            return (
                                                <>
                                                    <ul className="comments-reply" key={j}>
                                                        <li>
                                                            <div className="comment">
                                                                ...
                                                                <div className="comment-body">
                                                                    <div className="meta-data">
                                                                        ...
                                                                        <div className="rating-rating">
                                                                            {item2.stars.map((star, k) => {
                                                                                return <span key={k} className="la la-star">{star}</span>
                                                                            })}
                                                                        </div>
                                                                    </div>
                                                                    <p className="comment-content">
