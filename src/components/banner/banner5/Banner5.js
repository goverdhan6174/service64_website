...
class Banner5 extends Component {
    ...
    render() {
        return (
            <>
                <ModalVideo channel='youtube' isOpen={this.state.isOpen} videoId='rDYdeq3JW_E' onClose={() => this.setState({ isOpen: false })} />
                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    <div className="breadcrumb-content">
                                        <h2 className="breadcrumb__title mb-0">We connect people <br /> to solve problems from local <br /> service provider</h2>
                                    </div>
                                </div>
