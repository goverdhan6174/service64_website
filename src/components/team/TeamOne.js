...
class TeamOne extends Component {
    state = {
        teams: [
            {
                img: require('../../assets/images/shafikul-islam.jpg'),
            ...
            {
                img: require('../../assets/images/sumi.jpg'),
                title: 'Sumiya Akter',
                titleurl: '/list',
                stitle: 'Photographer',
                socials: [
            ...
            {
                img: require('../../assets/images/Md Juwel.jpg'),
                title: 'Md Juwel',
                titleurl: '/list',
            ...
            {
                img: require('../../assets/images/shahin-rahman.jpg'),
                title: 'Shahin Rahman',
                titleurl: '/list',
                stitle: 'Director',
                socials: [
