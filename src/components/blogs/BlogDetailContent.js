  ...
  render() {
    return (
      <>
        ...
        <MetaDecorator
          title={this.state.title + " | " + this.state.author}
          ...
          <div className="card-content pl-0 pr-0 pb-0">
            <ul className="post-author d-flex align-items-center justify-content-between mb-3">
              <li>
                ...
                <span>
                  {this.state.date} -{" "}
                  <Link to={this.state.metaLink} className="tag__text">
                    {this.state.meta}
                  </Link>
                </span>
              </li>
            ...
            <h2 className="card-title font-size-26">{this.state.title}</h2>
            <p className="card-sub mt-3">{this.state.desc1}</p>
            <p className="card-sub mt-3">{this.state.desc2}</p>

            <BlogBlockquote
              bgImg={this.state.bgimg}
              quoteIcon={this.state.quoteIcon}
              desc={this.state.desc}
              name={this.state.name}
              designation={this.state.designation}
            />

            <p className="card-sub margin-top-30px">{this.state.desc3}</p>
            ...
            <p className="card-sub mb-3">{this.state.desc4}</p>
            <h3 className="widget-title">Storytelling</h3>
            <p className="card-sub mb-3">{this.state.desc4}</p>
            <h3 className="widget-title">Branding</h3>
            <p className="card-sub">{this.state.desc4}</p>
